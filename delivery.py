...
class marca(tipoVehiculo):
    ...
    ***  🚚 DeliverY Los SolFaMiDas  🚚 ***
    ...
    def registrar(self):
        ...
        print(self.guardar(nombre, apellido, telefono, carnet, email, contra, tipoLicencia, vehiculo, tipoVehiculo,placa, cilindrada, marca, procedencia))
        otro = input("Desea registrar otro: s/n \n")
        if (otro == "s" or otro == "s"):
            self.registrar()
        return "--------------------"

    def guardar(self, nombre, apellido, telefono, carnet, email, contra, tipoLicencia, vehiculo, tipoVehiculo,placa, cilindrada, marca, procedencia):
        self.nombre.append(nombre)
        self.apellido.append(apellido)
        self.telefono.append(telefono)
        self.carnet.append(carnet)
